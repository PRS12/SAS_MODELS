...
%let lib = dp;  *Library Name;
%let set = base_4;  *Dataset Name;
%let basket_dimension = activity_id;  *Basket Dimension Identifier (ie customer id);
%let analysis_unit = sub_class_des;  *Analysis Unit Identifier (ie product id);
